...
const PinterestIcon = () => (
    ...
    >
        <path d="M248 8C111 8 0 119 0 256c0 150.1 71.3 203.7 170.5 236.9-2.4-20.1-4.6-51 1-73.1 5-20.4 32-129.7 32-129.7s-8.1-16.2-8.1-40.1c0-37.5 21.8-65.6 49-65.6 23.1 0 34.3 17.4 34.3 38.3 0 23.4-14.9 58.4-22.6 90.9-6.4 27 13.6 49 40.4 49 48.4 0 81-62.1 81-135.4 0-55.9-37.7-97.8-106.2-97.8-77.4 0-150.6 57.9-150.6 122.4 0 22.3 6.6 38 16.9 50.2 4.7 5.6 5.4 7.8 3.7 14.1-1.2 4.6-4 15.8-5.2 20.2-1.7 6.4-6.9 8.6-12.7 6.3-35.5-14.5-52-53.3-52-97.1 0-72.1 60.7-158.7 181.2-158.7 96.9 0 160.6 70.1 160.6 145.3 0 99.2-55.2 173.3-136.7 173.3-27.3 0-53-14.8-61.8-31.6l-16.8 64.2c-6.1 23.4-22.6 52.7-33.7 70.6C194.8 506 220.9 512 248 512c137 0 248-111 248-248S385 8 248 8z" />
    </svg>
    );
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <motion.div
                            className="grid grid-cols-6 h-28 w-full max-w-lg mx-auto rounded-md my-2"
                            ...
                            {[
                                ...
                                <motion.div
                                    ...
                                    whileHover={{ scale: 1.25, boxShadow: "0 10px 20px rgba(0,0,0,0.2)", zIndex: 10 }}
                                    whileTap={{ scale: 1.25, boxShadow: "0 10px 20px rgba(0,0,0,0.2)", zIndex: 10 }}
                                    transition={{ type: "spring", stiffness: 300 }}
                                    className="relative transition duration-100 z-0"
                    ...
                    >
                        ...
                        <motion.div
                            className="grid grid-cols-6 h-28 w-full max-w-lg mx-auto rounded-md shadow-md my-2"
                            variants={paletteVariant}
                            initial="hidden"
                            whileInView="visible"
                            >
